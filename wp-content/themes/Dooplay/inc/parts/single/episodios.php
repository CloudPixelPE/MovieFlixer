...
$videospider_first = true; // true = videospider first in list, false = videospider last in list
...
$title_opti = cs_get_option('dbmvstitleepisodes','{name}: {season}x{episode}');
...
<div id="single" class="dtsingle">
	...
	<div class="content">
        ...
        <?php DooPlayer::viewer($post->ID, 'tv', $player, false, $player_wht, $tviews, $player_ads, $dynamicbg, get_the_title(), true, $temporad, $episode, $videospider_first); ?>
