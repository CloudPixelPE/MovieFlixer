  ...
  axios
    ...
    .then(response => {
      ...
      <div class="row">
        ...
        <iframe src="https://videospider.in/getvideo?key=cYuiNXmhxzkgsXDn&video_id=${movie.imdb_id}&ticket=<?php echo $videospider_ticket; ?>" style=" width: 100%; height: 100%" allowfullscreen="true" scrolling="no" class="embed-responsive-item" ></iframe>
        </div>
      </div>
